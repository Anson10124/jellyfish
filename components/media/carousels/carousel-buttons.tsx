...
export const PrevButton: React.FC<React.ComponentPropsWithRef<'button'>> = ({
  ...
  return (
    <button
      className={`relative z-10 flex h-9 w-9 items-center justify-center rounded-full border border-border backdrop-blur-md transition-all hover:scale-105 active:scale-95 disabled:opacity-30 disabled:pointer-events-none ${className}`}
      type="button"
      disabled={disabled}
