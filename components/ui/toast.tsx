...
const toast = Object.assign(baseToast, {
  error: (title: React.ReactNode, description?: React.ReactNode) =>
    baseToast.add({ title, description, type: 'error', priority: 'high' }),
...
function Toast({ className, ...props }: ToastPrimitive.Root.Props) {
  return (
    <ToastPrimitive.Root
      data-slot="toast"
      className={cn(
        "group/toast pointer-events-auto absolute right-0 bottom-0 z-[calc(1000-var(--toast-index))] w-full origin-bottom rounded-2xl border border-white/15 bg-background/60 backdrop-blur-2xl text-foreground shadow-2xl will-change-transform outline-none select-none focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50",
